...
public class RangeTest {
	...
	// RANGE-34: combine with one null Range object and one negative value Range object
	@Test
	...
	// RANGE-35: combine with one empty Range object and one negative value Range object
	@Test
	...
	// RANGE-36: combine with one positive value Range object and one negative value Range object
	@Test
	...
	public void testCombineWithSecondParameterNull() {
		...
		boolean result = r3 != null; // add try/catch
	...
	public void testShiftWithPositiveValue() {
		...
		boolean result = rangeObjectUnderTest.getLength() == 8 && rangeObjectUnderTest.getLowerBound() == -2.5 && rangeObjectUnderTest.getUpperBound() == 5.5;
	...
	public void testShiftWithNegativeValue() {
		...
		boolean result = rangeObjectUnderTest.getLength() == 8 && rangeObjectUnderTest.getLowerBound() == -6 && rangeObjectUnderTest.getUpperBound() == 2;
	...
	public void testShiftWithZeroCrossingAllowed() {
		...
		boolean result = rangeObjectUnderTest.getLength() == 2 && rangeObjectUnderTest.getLowerBound() == 6 && rangeObjectUnderTest.getUpperBound() == 8;
	...
	public void testShiftWithEmptyRangeObjectAndZeroCrossingNotAllowed() {
		...
		boolean result = rangeObjectUnderTest.getLength() == 0 && rangeObjectUnderTest.getLowerBound() == 10 && rangeObjectUnderTest.getUpperBound() == 10;
